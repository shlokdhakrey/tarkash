-- InnovateX 2025 Seed Data (Authless PostgreSQL)
-- Run with: Get-Content seed-authless.sql | docker exec -i innovatex-postgres psql -U postgres -d innovatex
...
-- Create Admin User (email: admin@innovatex2025.edu, password: Admin123!)
...
-- Create Judge Users (all passwords: Admin123!)
INSERT INTO users (id, email, password, name, role, institute, bio, linkedin, github, "createdAt", "updatedAt")
VALUES 
...
INSERT INTO judges (id, "userId", bio, expertise, "createdAt", "updatedAt")
VALUES 
...
-- Create Participant Users (all passwords: Admin123!)
INSERT INTO users (id, email, password, name, role, institute, phone, year, "createdAt", "updatedAt")
VALUES 
...
-- Create Teams
INSERT INTO teams (id, name, institute, idea, status, "createdAt", "updatedAt")
VALUES 
...
-- Create Team Members
INSERT INTO team_members (id, "teamId", "userId", "isLeader", "createdAt", "updatedAt")
VALUES 
...
-- Create Submissions
INSERT INTO submissions (id, "teamId", title, description, status, "submittedAt", "createdAt", "updatedAt")
VALUES 
...
-- Create Sponsors
INSERT INTO sponsors (id, name, tier, logo, website, description, "createdAt", "updatedAt")
VALUES 
...
INSERT INTO timeline (id, title, description, datetime, location, "createdAt", "updatedAt")
VALUES 
...
-- Create FAQs
INSERT INTO faqs (id, question, answer, category, priority, "createdAt", "updatedAt")
VALUES 
...
INSERT INTO announcements (id, title, content, priority, pinned, "publishedAt", "createdAt", "updatedAt")
VALUES 
...
('ann-002', 'Sponsor Announcement', 'We are thrilled to announce TechCorp Inc. as our Platinum Sponsor!', 'MEDIUM', true, NOW(), NOW(), NOW()),
...
INSERT INTO rubrics (id, name, description, criteria, "createdAt", "updatedAt")
VALUES 
...
\echo '   Participant: alice@student.edu'
